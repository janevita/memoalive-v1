...
export const metadata = { title: 'Memories · Memoalive' }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-5 py-6 sm:py-10">
      ...
      <div className="mb-8 sm:mb-10">
        <p className="text-eyebrow mb-1">Your memories, {firstName}</p>
        ...
        <p className="text-ink-soft mt-2 text-sm sm:text-base">
          Your shared moments with people you love.
        </p>
      </div>
      ...
      {/* Recent memories across all events */}
